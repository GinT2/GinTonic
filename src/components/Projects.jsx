                  ...
                  >
                    {featuredProject.gallery.map((item, idx) => (
                      ...
                      >
                        ...
                        >
                          <Palette size={28} style={{ color: featuredProject.accent, opacity: 0.5 }} />
                          <span className="text-xs text-muted" style={{ textAlign: 'center', padding: '0 8px' }}>
                            {item.caption}
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div
                      style={{
                        position: 'absolute',
                        inset: 0,
                        display: item.type === 'link' ? 'flex' : 'none',
                        alignItems: 'center',
                        justifyContent: 'center',
                        flexDirection: 'column',
                        gap: '8px',
                    ...
                    >
                      {item.type === 'video' ? (
                        <Video size={28} style={{ color: project.accent, opacity: 0.5 }} />
                      ) : item.type === 'link' ? (
                        <FileText size={28} style={{ color: project.accent, opacity: 0.5 }} />
                      ) : (
                        <Palette size={28} style={{ color: project.accent, opacity: 0.5 }} />
                      )}
